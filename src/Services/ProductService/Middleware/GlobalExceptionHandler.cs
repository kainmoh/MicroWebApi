...
public class GlobalExceptionHandler
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        var (statusCode, message) = exception switch
        {
            ...
            InsufficientInventoryException => (HttpStatusCode.BadRequest, exception.Message),
            ServiceCommunicationException => (HttpStatusCode.ServiceUnavailable, exception.Message),
